...
describe("@module granax", function () {
  ...
  describe("@function tor", function () {
    ...
    it("should return the windows path", function () {
      expect(
        granax.tor("win32").includes("bin/Browser/TorBrowser/Tor/tor.exe")
      ).to.equal(true);
    });
    ...
    it("should return the macintosh path", function () {
      expect(
        granax
          .tor("darwin")
          .includes("bin/.tbb.app/Contents/MacOS/Tor/tor.real")
      ).to.equal(true);
    });
    ...
    it("should return the gnu+linux path", function () {
      expect(
        granax
          .tor("linux")
          .includes("bin/tor-browser_en-US/Browser/TorBrowser/Tor/tor")
      ).to.equal(true);
      expect(
        granax
          .tor("android")
